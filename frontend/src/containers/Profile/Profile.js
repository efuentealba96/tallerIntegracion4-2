...
const MyProfile = () => {
  ...
  const getUser = async () => {
    await axios
      .post(`${endpoint}/user`, { rut: 201577306 })
      .then((response) => {
                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="mt-3">
                            <br></br>
                            <h4 className="r2">
                              Nombre<p className="r1">{user.nombre}</p>
                            </h4>
                            <br></br>
                            <p className="r2">
                              Carrera:<p className="r1">{user.carrera}</p>
                            </p>
                            <br></br>
                            <p className="r2">
                              Rut:<p className="r1">{user.rut}</p>
                            </p>
                            <br></br>
                            <p className="r2">
                              Correo:<p className="r1">{user.correo}</p>
                            </p>
                            <br></br>
                            <p className="r2">
                              Domicilio:<p className="r1">{user.domicilio}</p>
                            </p>
                            <br></br>
                          </div>
                        </div>
                    ...
                    <div class="card mb-3">
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="textcard">username@alu.uct.cl</div>
                        </div>
                        <hr />
                        ...
                        <div class="row">
                          ...
                          <div class="textcard">(+569) 00000000</div>
                        </div>
                        <hr />
                        <div class="row">
                          <div class="col-sm-3">
