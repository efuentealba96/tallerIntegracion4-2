...
<input type="email" class="form-control {{$errors->has('ApellidoMaterno')?'is-invalid':''}}" name= "Correo" id="Correo" value="{{ isset ($empleado->Correo) ? $empleado->Correo:old('Correo')}}">
